      ...
      <div>
        ...
        <div class="footer-contact">
          ...
          <p>
            ...
            <a href="mailto:{{ \App\Models\Setting::get('butik_email','') }}">{{ \App\Models\Setting::get('butik_email','butik@email.com') }}</a>
          </p>
          <p>
            ...
            <a href="https://wa.me/{{ \App\Models\Setting::get('butik_wa','6281234567890') }}" target="_blank">WhatsApp Kami</a>
          </p>
        </div>
      </div>
    </div>
