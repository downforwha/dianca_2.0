  ...
  <div class="stat-card glass-panel quick-actions-panel" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); color: white;">
    <div class="stat-content w-100" style="width: 100%;">
      ...
      <div class="quick-actions-grid">
        <a href="{{ route('admin.koleksi.index') }}" class="btn-quick" title="Tambah Produk">
        ...
        <a href="{{ route('admin.keuangan.index') }}" class="btn-quick" title="Catat Transaksi">
    ...
    <div class="admin-card glass-panel">
      ...
      <div class="admin-card-body p-0">
        ...
        <div class="low-stock-item">
          @if($p->image)
            <img src="{{ asset('storage/'.$p->image) }}" alt="{{ $p->name }}" class="product-thumb" loading="lazy" decoding="async" width="40" height="40">
          @else
